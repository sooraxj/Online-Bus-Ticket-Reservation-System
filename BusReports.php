...
<div class="button-container">
    <div class="pspace">
        <a id="download-pdf" class="pdf btn1" href="Bus-pdf.php" target="_blank">Pdf</a>
    </div>
    <div class="space">
...
<script>
      function printBusPdfContent() {
        var printWindow = window.open('Bus-print.php', '_blank');
    ...
    XLSX.writeFile(wb, 'Bus-reports.xlsx');
});
