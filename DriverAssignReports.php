...
<head>
    ...
    <title>Driver Assignment Reports</title>
...
<body>
        ...
        <div class="pspace">
    <form action="Dassign-pdf.php" method="POST">
...
<script>
      function printBusPdfContent() {
        var printWindow = window.open('Dassign-print.php', '_blank');
    ...
    XLSX.writeFile(wb, 'Dassign-reports.xlsx');
});
