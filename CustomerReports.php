...
<body>
        ...
        <div class="pspace">
        <form action="Customer-pdf.php" method="POST">
...
<script>
      function printBusPdfContent() {
        var printWindow = window.open('Customer-print.php', '_blank');
    ...
    XLSX.writeFile(wb, 'Customer-reports.xlsx');
});
