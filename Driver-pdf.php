...
while ($row = $result->fetch_assoc()) {
    ...
    $a .= '
        <tr>
            <td>' . $serialNumber . '</td>
            <td>' . $row['D_fname'] . ' ' . $row['D_mname'] . ' ' . $row['D_lname'] . '</td>
            <td>' . $row['D_email'] . '</td>
            <td>' . $row['D_phone'] . '</td>
            <td>' . $row['D_licence_no'] . '</td>
            <td>' . $row['D_badge_no'] . '</td>
            <td>' . $row['D_city'] . '</td>
            <td>' . $row['D_state'] . '</td>
            <td>' . $genderDisplay . '</td>
            <td>' . $row['D_dob'] . '</td>
...
$mpdf->WriteHTML($a);
$mpdf->Output('Driver-reports.pdf', 'F');
header('Content-Type: application/pdf');
header('Content-Disposition: attachment; filename="Driver-reports.pdf"');
readfile('Driver-reports.pdf');
?>
