...
$ticketsSql = "SELECT t.*, c.C_fname, bm.Booking_date, GROUP_CONCAT(bc.Passenger_name) AS Passenger_names,
               ...
               WHERE t.Ticket_status = 1 $searchCondition
...
<div class="search">
                ...
                <div class="user">
                <a href="Aview_cancelledtkts.php" class="btn">Cancelled Tickets</a>
<div class="img-case">
                    ...
                    <td><?php echo $ticket['Ticket_number']; ?></td>
                        ...
                        <td class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="Aticket.php?ticket_id=<?php echo $ticket["Ticket_id"];?>">View Ticket</a>
                                <a href="admin_view_ticket.php?ticket_id=<?php echo $ticket["Ticket_id"];?>">Edit Ticket</a>
                                <?php
                                $editRequestsSql = "SELECT * FROM tbl_edit_ticket_requests WHERE Ticket_id = {$ticket['Ticket_id']} AND Status = 'Pending'";
                                $editRequestsResult = $conn->query($editRequestsSql);

                                if ($editRequestsResult->num_rows > 0) {
                                    echo '<a href="view_requests.php?ticket_id=' . $ticket["Ticket_id"] . '">View Edit Requests</a>';
                                }
                                ?>
                            </div>
                        </td>
