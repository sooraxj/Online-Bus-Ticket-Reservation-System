...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['seatcheckbox'])) {
    ...
    // Construct the redirect URL using POSTed data
    $redirectUrl = "passenger_info.php?bus_route_id=".$_POST['bus_route_id']."&Routename=".$_POST['Routename']."&starttime=" . $_POST['starttime']."&desttime=" . $_POST['desttime']."&Buscomp=".$_POST['Buscomp']."&journeyDate=".$_POST['journeyDate']."&start=".$_POST['start']."&destination=".$_POST['destination']."&distance=".$_POST['distance']."&fare=".$_POST['fare'];
...
$query = "SELECT DISTINCT bc.Seat_number
...
<br>
    ...
    <input type="hidden" name="Buscomp" value="<?php echo $Buscomp; ?>">
                <ol class="bus_seat"><br>   
                    ...
                    $totalRows = 10;
                    $seatsPerRow = 5;
                    $gapSize = 1; // Gap between sets of 2 and 3 seats
