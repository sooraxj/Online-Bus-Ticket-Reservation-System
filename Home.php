...
<div class="brand-name">  
    ...
    <div class="profile-dropdown">
        ...
        <?php
                if (isset($_SESSION["username"])) {
                    ...
                    $getCustomerNameQuery = "SELECT C_fname,C_dist FROM tbl_Customer WHERE Username = '$loggedInUsername'";
                    $nameResult = $conn->query($getCustomerNameQuery);
                       
                    if ($nameResult->num_rows > 0) {
                        $nameRow = $nameResult->fetch_assoc();
                        $customerFirstName = $nameRow["C_fname"];
                        $customerdist = $nameRow["C_dist"];
        ...
        <div class="profile-card text-center p-4">
                    <span class="profile-icon fas fa-user"></span>
                    <h2 class="profile-name"><?php echo $customerFirstName; ?></h2>
                    <p class="profile-email"><?php echo $loggedInUsername; ?></p>
                    <p class="profile-location"><?php echo $customerdist; ?></p>
    ...
    <div class="video-text">
        ...
        <div class="search-form">
            <form id="searchForm" method="post" action="search_stops.php" autocomplete="off">
